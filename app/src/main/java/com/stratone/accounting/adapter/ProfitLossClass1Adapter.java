...
public class ProfitLossClass1Adapter extends ArrayAdapter<ProfitLossClass1> {
    private Context mContext;
    private int mResource;
    private String sDate;
    private String eDate;
    public ProfitLossClass1Adapter(@NonNull Context context, int resource, @NonNull List<ProfitLossClass1> objects,
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout,profitLossClass2Fragment)
