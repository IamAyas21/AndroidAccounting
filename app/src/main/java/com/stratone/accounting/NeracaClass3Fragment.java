 ...
 * Use the {@link NeracaClass3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class NeracaClass3Fragment extends Fragment {
     ...
     * @return A new instance of fragment NeracaClass3Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static NeracaClass3Fragment newInstance(String param1, String param2) {
        NeracaClass3Fragment fragment = new NeracaClass3Fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                ...
                NeracaClass2Fragment neracaClass2Fragment = SessionFragment(aClassId, bClassId, sDate, eDate);
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout,neracaClass2Fragment)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_neraca_class3, container, false);
    ...
    private void ListClass3(String classId, String userId, final String startDate, final String endDate) {
        apiService.NeracaClass3(userId, startDate, endDate, classId).enqueue(new Callback<ResponseNeracaClass2>() {
            @Override
            public void onResponse(Call<ResponseNeracaClass2> call, Response<ResponseNeracaClass2> response) {
                if(response.body().getStatus().equals("success"))
                {
                    ...
                    expandableListAdapter = new NeracaClass3Adapter(getActivity(), expandableListTitle, expandableListDetail,startDate,endDate,aClassId,"3");
    ...
    private NeracaClass2Fragment SessionFragment(String aClassId, String bClassId, String startDate, String endDate)
    {
